...
public class DataSourceContextHolder {
	...
	private static final ThreadLocal<String> dataSourceKeyHolder = new TransmittableThreadLocal<>();
	
	private static final ThreadLocal<String> tableKeyHolder = new TransmittableThreadLocal<>();
